...
def process_mnist():
	f = open("resources/mnist_train.csv", 'r')
	data = f.readlines()
	f.close()
	f = open("resources/mnist_test.csv", 'r')
	...
	print("Accuracy is", correct/len(test_data),"\nGot", correct, "correct answers out of", len(test_data))
